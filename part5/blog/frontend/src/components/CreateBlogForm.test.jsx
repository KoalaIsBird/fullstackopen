...
test('new blog event handler receives the correct info from form', async () => {
  ...
  await user.type(screen.getByPlaceholderText('write blog title here'), '10 Biggest Rockets')
  ...
  expect(handleCreate.mock.calls[0]).toEqual(['10 Biggest Rockets', 'Elon Musk', 'spacex.com'])
})
